...
func (f *fakeAdhkarRepo) GetCategories(ctx context.Context) ([]model.DhikrCategory, error) {
...
func (f *fakeAdhkarRepo) GetAdhkarBySlug(ctx context.Context, slug string) ([]model.Dhikr, error) {
	return nil, nil
}
...
func (f *fakeAdhkarRepo) GetSourcesByDhikr(ctx context.Context, dhikrID int) ([]model.DhikrSource, error) {
	return nil, nil
}
func (f *fakeAdhkarRepo) CreateCompletion(ctx context.Context, c *model.AdhkarCompletion) error {
	return nil
}
...
func (f *fakeAdhkarRepo) CreateReminder(ctx context.Context, rem *model.AdhkarReminder) error {
	return nil
}
func (f *fakeAdhkarRepo) UpdateReminder(ctx context.Context, rem *model.AdhkarReminder) error {
	return nil
}
func (f *fakeAdhkarRepo) GetReminder(ctx context.Context, userID string, categoryID int) (*model.AdhkarReminder, error) {
	return nil, nil
}
func (f *fakeAdhkarRepo) GetReminders(ctx context.Context, userID string) ([]model.AdhkarReminder, error) {
	return nil, nil
}
func (f *fakeAdhkarRepo) DeleteReminder(ctx context.Context, userID string, categoryID int) error {
	return nil
}
func (f *fakeAdhkarRepo) GetActiveAdhkarCount(ctx context.Context) (int, error) {
	return len(f.adhkar), nil
}
...
func TestGetDailyProgress(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, time.Now().UTC().Format("2006-01-02"), p.Date)
}
